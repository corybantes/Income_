...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        t1.setBackground(new java.awt.Color(224, 250, 250));
        ...
        forgotpassword.setBackground(new java.awt.Color(204, 255, 255));
        ...
        p1.setBackground(new java.awt.Color(224, 255, 255));
        ...
        jLabel3.setText("Balance Manager");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(39, 39, 39)
                        .addComponent(forgotpassword, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(156, 156, 156))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        login3.logindetails = t1.getText();
        try{
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/income","root","Gorybantesstoresdata.00");
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("select password from admin where company_name = '"+name+"';");
            if(rs.next()){
